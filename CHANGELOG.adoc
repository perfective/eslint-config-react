...
== v0.10.0-alpha.1 (next)

* Updated `link:https://github.com/perfective/eslint-config[@perfective/eslint-config]`
to `link:https://github.com/perfective/eslint-config/releases/tag/v0.20.0-alpha.1[0.20.0-alpha.1]`.
* Update `eslint-plugin-jsx-a11y` to `6.7.0`:
** Enabled the `link:https://github.com/jsx-eslint/eslint-plugin-jsx-a11y/blob/master/docs/rules/prefer-tag-over-role.md[jsx-a11y/prefer-tag-over-role]` rule as an error.
+
