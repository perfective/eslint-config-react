...
| `link:https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/no-object-type-as-default-prop.md[react/no-object-type-as-default-prop]`
|
|
| Error
...
| `link:https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/sort-default-props.md[react/sort-default-props]`
|
|
| Error
...
| `link:https://github.com/yannickcr/eslint-plugin-react/blob/master/docs/rules/jsx-no-leaked-render.md[react/jsx-no-leaked-render]`
|
| Yes
| Warning
